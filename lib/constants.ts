...
export const SITE = {
  ...
  description:
    "Full-stack and AI systems architect working across ZK proofs, graph databases, vector search, and real-time PKI-secured telemetry. Full-time at Kottackal Business Solutions.",
} as const;
