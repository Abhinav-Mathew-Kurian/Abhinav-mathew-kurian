...
const experience = [
  ...
  },
  {
    ...
    current: false,
    summary:
      "Built the EV Driver Portal — interactive maps, OCPP 1.6 charging simulation, Razorpay payment integration, and real-time dashboards using Socket.IO and Recharts.",
    description:
      "• Built the EV Driver Portal — interactive maps, OCPP 1.6 charging simulation, Razorpay payment integration, and real-time dashboards using Socket.IO and Recharts.",
    order: 2,
  },
